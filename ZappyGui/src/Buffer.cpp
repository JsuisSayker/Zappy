 ...
 */
VkDeviceSize ZappyBuffer::getAlignment(
 ...
 *
 */
void ZappyBuffer::writeToBuffer(
 ...
 */
VkDescriptorBufferInfo ZappyBuffer::descriptorInfo(
 ...
 *
 */
VkResult ZappyBuffer::flushIndex(int index)
{
