...
lve::Glyph::Glyph(FT_Face face, FT_UInt ix, std::shared_ptr<TextureAtlas> ta)
{
    m_face = face;
    m_glyphIndex = ix;
...
void lve::Glyph::CreateTextureFromBitmap(std::shared_ptr<TextureAtlas> &ta)
{
    FT_GlyphSlot glyphSlot = m_face->glyph;
...
int lve::Glyph::GetLeft() { return m_left; }

int lve::Glyph::GetTop() { return m_top; }

int lve::Glyph::GetWidth() { return m_width; }

int lve::Glyph::GetHeight() { return m_height; }

int lve::Glyph::GetAdvance() { return m_advance; }
