...
ZappySwapChain::ZappySwapChain(
    ZappyDevice &deviceRef, VkExtent2D extent, std::shared_ptr<ZappySwapChain> previous)
...
VkResult ZappySwapChain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex) {
...
VkExtent2D ZappySwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
