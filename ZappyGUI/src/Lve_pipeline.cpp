...
/**
 * @brief Constructs an LvePipeline object with the specified device, vertex
 * shader file, fragment shader file, and configuration information.
 *
 ...
 */
lve::LvePipeline::LvePipeline(LveDevice &device,
...
{
    vkDestroyShaderModule(device.device(), this->vertShaderModule, nullptr);
    vkDestroyShaderModule(device.device(), this->fragShaderModule, nullptr);
    vkDestroyPipeline(device.device(), this->graphicsPipeline, nullptr);
}
 ...
 * @return std::vector<char> The contents of the file as a vector of
 * characters.
...
/**
 * @brief Creates a graphics pipeline using the specified vertex and fragment
 * shader files.
 *
 * @param vertFilepath The filepath of the vertex shader file.
 * @param fragFilepath The filepath of the fragment shader file.
 * @param configInfo The configuration information for the pipeline.
 */
void lve::LvePipeline::createGraphicsPipeline(const std::string &vertFilepath,
    const std::string &fragFilepath, const PipelineConfigInfo &configInfo)
{
    ...
    // Create the base pipeline for optimization
...
/**
 * @brief Creates a shader module using the specified shader code.
 *
 * @param code The shader code.
 * @param shaderModule The shader module to be created.
 */
void lve::LvePipeline::createShaderModule(
...
/**
 * @brief Creates a default pipeline configuration information object with the
 * specified width and height.
 *
 * @param width The width of the pipeline.
 * @param height The height of the pipeline.
 * @return PipelineConfigInfo The default pipeline configuration information
 * object.
 */
lve::PipelineConfigInfo lve::LvePipeline::defaultPipelineConfigInfo(
