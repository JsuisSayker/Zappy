...
/**
 * @brief Constructs an LveWindow object with the specified width, height, and window name.
 *
 ...
 * 
 * This function initializes the GLFW library and creates a window with the specified width, height, and window name.
 * 
 * @param width The width of the window.
 * @param height The height of the window.
 * @param windowName The name of the window.
 ...
 * 
 * This function checks if the window should close and returns a boolean value indicating whether the window should close.
 * 
