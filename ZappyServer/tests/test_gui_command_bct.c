...
Test(gui_command_bct, test_gui_command_bct)
{
    ...
    if (pid_1 == 0) {
        // Child process
        sleep(sleep_time);
        char **commands = splitter("GRAPHIC|bct 1 1", "|");
        client("127.0.0.1", args->port, commands, 3);
        free_array(commands);
        exit(0);
    } else {
        pid_t pid_2 = fork();
...
Test(gui_command_bct, test_gui_command_bct_bad_nb_arg)
{
    // Configuration for the server
    int sleep_time = 3;
    args_config_t *args = calloc(1, sizeof(args_config_t));
    ...
    if (pid_1 == 0) {
        // Child process
        sleep(sleep_time);
        char **commands = splitter("GRAPHIC|bct 1", "|");
        client("127.0.0.1", args->port, commands, 3);
        free_array(commands);
        exit(0);
    } else {
...
Test(gui_command_bct, test_gui_command_bct_bad_cmd)
{
    // Configuration for the server
    int sleep_time = 3;
    args_config_t *args = calloc(1, sizeof(args_config_t));
    ...
    if (pid_1 == 0) {
        // Child process
        sleep(sleep_time);
        char **commands = splitter("GRAPHIC|bctaze", "|");
        client("127.0.0.1", args->port, commands, 3);
        free_array(commands);
        exit(0);
    } else {
...
Test(gui_command_bct, test_gui_command_bct_bad_coordinate)
{
    // Configuration for the server
    int sleep_time = 3;
    args_config_t *args = calloc(1, sizeof(args_config_t));
    ...
    if (pid_1 == 0) {
        // Child process
        sleep(sleep_time);
        char **commands = splitter("GRAPHIC|bct 100 4", "|");
        client("127.0.0.1", args->port, commands, 3);
        free_array(commands);
        exit(0);
    } else {
